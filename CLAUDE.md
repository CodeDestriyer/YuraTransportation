...
- Максимум точок доставки: 100 (за замовчуванням)
...
| **Бот Посилки** (`Script-Cargo.gs`) | `https://script.google.com/macros/s/AKfycbw2oc9KUVALoS97FjrUtjd-r2nqBVj2Il_wkCz1G44vFbiBcyB3cCwXbueofAFGE3cwSA/exec` |
